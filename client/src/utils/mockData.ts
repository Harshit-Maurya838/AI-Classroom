import { StudyPlan, User, Wallet, Test, Interview, Note } from '../types';
...
function getTopicAreas(topic: string, level: string): string[] {
  // These would normally be generated by AI based on the topic
...
export const mockNotes: Note[] = [
  {
    ...
    content: 'This is a summary of the key concepts covered in your lessons. These notes are generated based on your learning material and are designed to help you review and retain information effectively.',
    createdAt: new Date(),
    revisionDates: [
